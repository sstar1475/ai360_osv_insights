...
class Vulnerability(Base):
    ...
    @property
    def equivalent_aliases(self) -> List["Vulnerability"]:
        """Возвращает всех соседей по графу элиасов"""
        return self.alias_forward_neighbors + self.alias_backward_neighbors

    @property
    def equivalent_related(self) -> List["Vulnerability"]:
        """Возвращает всех соседей по графу связанных"""
        return self.related_forward_neighbors + self.related_backward_neighbors
